...
foto=['1.png', '2.png', '3.png', '4.png', '5.png', '6.png', '7.png', '8.png', '9.png', '10.png', '11.png', '12.png', '13.png', '14.png', '15.png', '16.png', '17.png', '18.png', '19.png', '20.png', '21.png', '22.png', '23.png', '24.png', '25.png', '26.png', '27.png']
...
layout = [[sg.Combo(s, default_value=s[0], s=(15,22), enable_events=True, readonly=True, k='-COMBO-', key='Combo'), sg.Output(s=(90,25), key='outputt')], [sg.Button('Старт', font=('Impact', 12), button_color=('black', '#FFFFFF'), key='process'),
	   ...
	   sg.Button('Выход', font=('Impact', 12), button_color=('black', '#FFFFFF'), key='exit'), sg.Combo(foto, default_value=foto[0], enable_events=True, readonly=True, k='-COMBO-', key='Combo')],
